...
-- bloqueia acesso se não estiver na whitelist
if not IsWhitelisted(LocalPlayer) then
return -- sai do script se não for autorizado
end
...
if not IsWhitelisted(plr) then return end -- bloqueia quem não tá na whitelist  
...
AdminTab:Button({Title="Kill", Callback=function() SendCommand(";kill "..Selected) end})
AdminTab:Button({Title="Freeze", Callback=function() SendCommand(";freeze "..Selected) end})
AdminTab:Button({Title="UnFreeze", Callback=function() SendCommand(";unfreeze "..Selected) end})
AdminTab:Button({Title="Jail", Callback=function() SendCommand(";jail "..Selected) end})
AdminTab:Button({Title="UnJail", Callback=function() SendCommand(";unjail "..Selected) end})
AdminTab:Button({Title="Fling", Callback=function() SendCommand(";fling "..Selected) end})
AdminTab:Button({Title="Bring", Callback=function() SendCommand(";bring "..Selected) end})